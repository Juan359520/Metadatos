...
This outlines how to propose a change to Metadatos. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Juan359520/Metadatos", fork = TRUE)`.
...
Please note that the Metadatos project is released with a [Contributor
Code of
Conduct](https://juan359520.github.io/Metadatos/CODE_OF_CONDUCT.md). By
